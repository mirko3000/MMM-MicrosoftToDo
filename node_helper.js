  ...
  getTodos: function (config) {
    ...
    function (error, response, body) {
      ...
      var _getTodos = function () {
        ...
        var listUrl = 'https://graph.microsoft.com/beta/me/outlook/taskFolders/' + config.listId + '/tasks?$select=subject,status,owner,assignedTo,dueDateTime,importance&$top=' + config.itemLimit + '&$filter=status%20ne%20%27completed%27' + orderBy
